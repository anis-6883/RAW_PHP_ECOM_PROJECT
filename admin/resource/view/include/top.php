...
<head>
    ...
    <script src="public/js/richTextEditor/tinyRTE.js"></script>
    <!-- jQuery library -->
    <script src="public/js/jQuery/jquery-3.6.0.js"></script>
</head>
            ...
            <div class="header-content clearfix">
                ...
                <div class="header-right">
                    <ul class="clearfix">
                                    ...
                                    <ul>
                                        <li class="notification-unread">
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="public/images/avatar/1.jpg" alt="">
                        ...
                        <li class="icons dropdown"><?php echo @$_SESSION['ECOM_admin_name'] ?></li>

                        <li class="icons dropdown">
                            <div class="user-img c-pointer position-relative" data-toggle="dropdown">
                                <span class="activity active"></span>
                                <img src="public/images/user/1.png" height="40" width="40" alt="">
                            </div>
